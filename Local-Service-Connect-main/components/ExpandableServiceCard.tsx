...
export function ExpandableServiceCard({ services }: { services: ServiceCard[] }) {
              ...
              <div>
                <div className="flex justify-between items-start p-4">
                  ...
                  <motion.a
                    ...
                    href={active.ctaLink}
                    target="_blank"
                    className="px-4 py-3 text-sm rounded-full font-bold bg-[#C4DFDF] text-gray-800 hover:bg-[#D2E9E9]"
                    rel="noreferrer"
                  >
                    {active.ctaText}
                  </motion.a>
        ...
        {services.map((service) => (
          ...
          >
            ...
            <motion.button
              ...
              className="px-4 py-2 text-sm rounded-full font-bold bg-[#C4DFDF] text-gray-800 hover:bg-[#D2E9E9] mt-4 md:mt-0"
            >
              {service.ctaText}
            </motion.button>
          </motion.div>
