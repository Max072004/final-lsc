...
export default function WorkerSubscription() {
  ...
  const plans = [
    ...
    },
    {
      ...
      price: "₹150",
      duration: "per year",
      features: ["All 6-month features", "Priority job access", "Premium support"],
    },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-indigo-200 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-4xl font-bold mb-4 text-indigo-900">Worker Subscription Plans</h1>
          <p className="text-lg text-indigo-700 max-w-2xl mx-auto">
            Boost your career with our subscription plans designed for service professionals.
          </p>
        </div>
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <h3 className="text-2xl font-bold mb-6 text-center text-indigo-900">Why Subscribe as a Worker?</h3>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white/80 p-6 rounded-xl shadow-md">
              ...
              <h4 className="text-lg font-semibold mb-2 text-center text-indigo-800">More Job Opportunities</h4>
              <p className="text-indigo-700 text-center">
                Get access to a wider range of job opportunities and connect with more potential clients.
              </p>
            </div>
            <div className="bg-white/80 p-6 rounded-xl shadow-md">
              <div className="flex justify-center mb-4">
              ...
              <h4 className="text-lg font-semibold mb-2 text-center text-indigo-800">Priority Listings</h4>
              <p className="text-indigo-700 text-center">
                Your profile appears higher in search results, increasing your visibility to potential clients.
              </p>
            </div>
            <div className="bg-white/80 p-6 rounded-xl shadow-md">
              <div className="flex justify-center mb-4">
              ...
              <h4 className="text-lg font-semibold mb-2 text-center text-indigo-800">Professional Badge</h4>
              <p className="text-indigo-700 text-center">
                Earn a verified professional badge that builds trust with potential clients.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 bg-white/80 p-6 rounded-xl max-w-4xl mx-auto">
          <h3 className="text-2xl font-bold mb-4 text-indigo-900">Plan Comparison</h3>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr>
                  <th className="text-left p-3 text-indigo-900">Feature</th>
                  <th className="text-center p-3 text-indigo-900">6-Month Plan</th>
                  <th className="text-center p-3 text-indigo-900">Yearly Plan</th>
                </tr>
              </thead>
              <tbody>
