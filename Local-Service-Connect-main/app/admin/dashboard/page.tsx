...
import { ArrowRight, Users, Briefcase, DollarSign, Calendar, Settings, Bell, Search, Menu } from "lucide-react"
            ...
            <div className="flex items-center">
              <Sheet>
                <SheetTrigger asChild>
                  <Button variant="ghost" size="icon" className="md:hidden mr-2 hover:rotate-180 transition-transform duration-300">
                    <Menu />
                  </Button>
                </SheetTrigger>
              ...
              <h1 className="text-2xl font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Dashboard Overview</h1>
            </div>
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
              {[
                { title: "Total Users", icon: Users, value: "1,234", change: "+10%", color: "from-blue-500 to-blue-600" },
                { title: "Active Workers", icon: Briefcase, value: "567", change: "+5%", color: "from-green-500 to-green-600" },
                { title: "Total Revenue", icon: DollarSign, value: "$45,231.89", change: "+20%", color: "from-purple-500 to-purple-600" },
                { title: "Completed Jobs", icon: Calendar, value: "789", change: "+12%", color: "from-pink-500 to-pink-600" },
              ].map((item, index) => (
                <Card key={index} className="overflow-hidden transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
                  ...
                  <ResponsiveContainer width="100%" height={350}>
                    <BarChart data={data}>
                      ...
                      <ChartTooltip 
                        ...
                        content={
                          <ChartTooltipContent 
                            className="bg-white p-2 shadow-lg rounded-lg border border-gray-200"
                          />
                        }
                      />
                      <Bar 
            ...
            <Card className="transform hover:shadow-xl transition-all duration-300">
              ...
              <CardContent>
                <Table>
                  ...
                  <TableBody>
                    {[
                      { activity: "New user registration", status: "Completed", date: "2023-06-15" },
                      { activity: "Service booking: Plumbing", status: "In Progress", date: "2023-06-14" },
                      { activity: "Worker application: Electrician", status: "Pending Review", date: "2023-06-13" },
                    ].map((item, index) => (
            ...
            {/* Quick actions */}
            <div className="mt-8">
              <h2 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-4">Quick Actions</h2>
